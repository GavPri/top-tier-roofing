...
const Logos2 = () => {
  return (
    <section className="mx-auto max-w-4/5 lg:min-w-4/5">
      <div className="container ">
        <div className="grid overflow-hidden rounded-xl border border-border md:grid-cols-2 bg-card">
          <div className="my-auto px-6 py-10 sm:px-10 sm:py-12 lg:p-16">
            <div className="w-full md:max-w-md">
              <h2 className="mb-4 text-2xl font-semibold lg:text-3xl text-foreground">
                Our certifications say it all.
              </h2>
              <p className="mb-6 text-lg text-muted-foreground">
                Trading Standards approved and fully accredited. We're proud
                members of leading industry bodies, ensuring every project meets
